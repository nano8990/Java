...
public class RandomTenReturn extends Random {
	...
	public static void main(String[] args) {
		Random randomtenreturn = new RandomTenReturn();
		((RandomTenReturn) randomtenreturn).nextIntTen(100);
		int[] a = ((RandomTenReturn)randomtenreturn).resultArr;
