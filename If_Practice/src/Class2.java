...
public class Class2 {
	public static void main(String[] args) {
		System.out.println("가위 · 바위 · 보를 입력하세요.\r");
		for (int i = 0; i < 1; i++) {
			...
			if ("가위".equals(입력값) || "바위".equals(입력값) || "보".equals(입력값)) {
				...
				case 0:
					...
					case "가위":
						...
						System.out.println("비겼습니다. 다시 하세요.\r");
						i--;
						break;
					case "바위":
						System.out.println("당신 : 바위");
						System.out.println("이겼습니다.\r");
						break;
					case "보":
						System.out.println("당신 : 보");
						System.out.println("패배했습니다.\r");
						break;
					}
					;
					break;
				...
				System.out.println("이상한 값 입력하지 말고 시키는대로 하세요.\r");
				i--;
			}
		}
	}
