...
public class StudentInformationMainRun {
...
//		s1.memo = "매사에 진취적임";
		...
		StudentInformation[] sArray = new StudentInformation[10]; // 배열(10개짜리 변수)을 만드는 것
		Scanner scan = new Scanner(System.in);
		for (int i = 0; i < sArray.length; i++) {
			sArray[i] = new StudentInformation(); // 각각의 변수에 넣는 것
