...
public class Three69Person {
	String name;
	Three69Person[] players;
	int position = 0;
	int startNumber = 0;
	int endNumber = 0;
	int sayNumber = 0;

	Three69Person(String name) {
		this.name = name;
	}

	public void readyGame(Three69Person[] players, int position, int startNumber, int endNumber) {
